	soc_system u0 (
		...
		.stepper_1_speed_external_connection_export     (<connected-to-stepper_1_speed_external_connection_export>),     //     stepper_1_speed_external_connection.export
		.stepper_1_steps_in_external_connection_export  (<connected-to-stepper_1_steps_in_external_connection_export>),  //  stepper_1_steps_in_external_connection.export
		.stepper_1_steps_out_external_connection_export (<connected-to-stepper_1_steps_out_external_connection_export>), // stepper_1_steps_out_external_connection.export
		.stepper_2_speed_external_connection_export     (<connected-to-stepper_2_speed_external_connection_export>),     //     stepper_2_speed_external_connection.export
		.stepper_2_steps_in_external_connection_export  (<connected-to-stepper_2_steps_in_external_connection_export>),  //  stepper_2_steps_in_external_connection.export
		.stepper_2_steps_out_external_connection_export (<connected-to-stepper_2_steps_out_external_connection_export>), // stepper_2_steps_out_external_connection.export
		.stepper_3_speed_external_connection_export     (<connected-to-stepper_3_speed_external_connection_export>),     //     stepper_3_speed_external_connection.export
		.stepper_3_steps_in_external_connection_export  (<connected-to-stepper_3_steps_in_external_connection_export>),  //  stepper_3_steps_in_external_connection.export
		.stepper_3_steps_out_external_connection_export (<connected-to-stepper_3_steps_out_external_connection_export>), // stepper_3_steps_out_external_connection.export
